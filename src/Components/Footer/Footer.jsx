      ...
      <div className="secContent container">
        ...
        <div className="footerCard flex ">
          <div className="footerIntro flex">
            ...
            <div  data-aos="fade-up" className="footerParagraph flex">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Laudantium repellat expedita aliquid culpa sint, eos, provident eum vel, iste a laborum iusto saepe.
            </div>
          ...
          dat-aos-duration="5000"
            className="footerLinks grid">
            <div className="linkGroup">
              <span className="groupTitle">LastMinute</span>
              <li className="footerList flex">
                <FiChevronRight className="icon"/>
                Service
              </li>
